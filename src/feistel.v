module masked_feistel_function (
    ...
    input [31:0] rnd_mask,  // Random mask from LFSR for re-masking
    ...
    // Use a pseudo-random value generated by an LFSR for better security.
    wire [31:0] M_sbox_out = rnd_mask; // Dynamically generated re-masking strategy
